...
<html>
  <head>
    ...
    <title>Khurasan | Marble Factory</title>
    ...
    <!--<link rel="stylesheet" href="<?=base_url();?>public/bootstrap/css/dataTables.bootstrap.min.css">-->
    <!-- iCheck -->
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?=site_url()?>" class="logo">
          ...
          <span class="logo-lg"><b>Khurasan</b>Marbles</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?=base_url();?>public/img/IMG_0403.jpg" class="user-image" alt="User Image">
                  <span class="hidden-xs">Habib Ullah</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      Habib Ullah - CEO
                      <small>Company since Nov. 2012</small>
                    </p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
